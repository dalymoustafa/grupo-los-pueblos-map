...
async function main() {
  ...
  const record = allRecords.find(r =>
    r.fields["Name"] && r.fields["Name"].toLowerCase().includes("grupo los pueblos")
  );

  if (!record) { console.error("Could not find Grupo Los Pueblos!"); process.exit(1); }
...
<head>
  ...
  <title>Grupo Los Pueblos — Office Locations</title>
